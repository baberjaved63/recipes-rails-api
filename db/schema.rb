...
ActiveRecord::Schema[7.0].define(version: 2022_09_22_132302) do
  ...
  create_table "recipe_ratings", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "rating"
    t.bigint "recipe_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
